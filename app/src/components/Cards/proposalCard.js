...
//                     <Typography variant="body2" color="textSecondary" component="p" style={{height:70, display:"inline"}}>
...
// //     <div style={{backgroundColor: "black", color: "white", height:50, opacity: 0.7}}>
// //         MoreInfo
// //     </div>
// // </Slide>
